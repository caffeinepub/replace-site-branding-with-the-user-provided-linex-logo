...
export const services: Service[] = [
  {
    ...
    title: "PLC Systems",
    description:
      "Programmable Logic Controllers for reliable industrial automation and process control.",
    detailedDescription:
  ...
  },
  {
    ...
    title: "HMI Solutions",
    description:
      "Human Machine Interface systems for intuitive operator control and monitoring.",
    detailedDescription:
  ...
  },
  {
    ...
    title: "SCADA Systems",
    description:
      "Supervisory Control and Data Acquisition for comprehensive facility monitoring.",
    detailedDescription:
  ...
  },
  {
    ...
    title: "Servo Systems",
    description:
      "Precision servo motor systems for accurate motion control applications.",
    detailedDescription:
  ...
  },
  {
    ...
    title: "VFD Solutions",
    description:
      "Variable Frequency Drives for efficient motor speed control and energy savings.",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "Custom-designed control panels built to specification and industry standards.",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "Comprehensive energy monitoring and management systems for operational efficiency.",
    detailedDescription:
  ...
  },
  {
    ...
    title: "Industry 4.0",
    description:
      "Smart manufacturing solutions integrating IoT, AI, and data analytics for digital transformation.",
    detailedDescription:
