...
export default function ServiceCard({ service, onClick }: ServiceCardProps) {
  return (
    <Card
      className="group flex h-full flex-col cursor-pointer transition-all duration-300 hover:shadow-lg hover:border-industrial-accent/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
      onClick={onClick}
      tabIndex={0}
      onKeyDown={(e) => {
